import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.CPs9Ukbn.js";const y=JSON.parse('{"title":"RUYI 包管理器","description":"","frontmatter":{},"headers":[],"relativePath":"zh/ruyi/index.md","filePath":"zh/ruyi/index.md","lastUpdated":1712379824000}'),e={name:"zh/ruyi/index.md"},l=n(`<h1 id="ruyi-包管理器" tabindex="-1">RUYI 包管理器 <a class="header-anchor" href="#ruyi-包管理器" aria-label="Permalink to &quot;RUYI 包管理器&quot;">​</a></h1><p>RUYI 包管理是 RuyiSDK中负责管理RuyiSDK各种软件源的工具，用于管理工具链、模拟器、源码等各种二进制软件包和源码包。</p><ul><li>官方仓库：<a href="https://github.com/RuyiSDK/ruyi" target="_blank" rel="noreferrer">https://github.com/RuyiSDK/ruyi</a></li><li>下载地址：可在 <a href="https://github.com/RuyiSDK/ruyi/releases/" target="_blank" rel="noreferrer">GitHub Releases</a> 或 <a href="https://mirror.iscas.ac.cn/RuyiSDK/ruyi/releases" target="_blank" rel="noreferrer">ISCAS 镜像源</a>下载最新版本体验</li><li>需求与问题：ruyi 包管理器的问题和需求可以通过<a href="https://github.com/RuyiSDK/ruyi/issues" target="_blank" rel="noreferrer">仓库issue</a>反馈</li></ul><h2 id="支持的发行版平台" tabindex="-1">支持的发行版平台 <a class="header-anchor" href="#支持的发行版平台" aria-label="Permalink to &quot;支持的发行版平台&quot;">​</a></h2><p>当前 RUYI 包管理器具有良好的平台兼容性以及多发行版兼容性，目前经过测试可用的环境有（仅限验证过的）：</p><ul><li>x86_64 Fedora 38</li><li>x86_64 Ubuntu 22.04 LTS</li><li>x86_64 openEuler 23.09</li><li>riscv64 RevyOS 20231210</li><li>riscv64 openEuler 23.09</li></ul><p>上述操作系统链接参考本文文末的“附:外部链接”章节。</p><h2 id="命令" tabindex="-1">命令 <a class="header-anchor" href="#命令" aria-label="Permalink to &quot;命令&quot;">​</a></h2><p>RUYI 目前支持的命令如下：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 从配置的软件源更新本地软件包缓存</span></span>
